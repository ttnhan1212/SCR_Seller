...
const routes = [
    Object.assign({ path: '', component: _navigation_page__WEBPACK_IMPORTED_MODULE_3__["NavigationPage"], children: [
            ...
            {
                path: 'request/plate',
                loadChildren: () => __webpack_require__.e(/*! import() | platenumber-platenumber-module */ "platenumber-platenumber-module").then(__webpack_require__.bind(null, /*! ./platenumber/platenumber.module */ "./src/app/pages/navigation/platenumber/platenumber.module.ts")).then((m) => m.PlatenumberPageModule),
            },
            {
                path: 'ongoing',
            ...
            {
                path: 'setting',
                loadChildren: () => Promise.all(/*! import() | settings-settings-module */[__webpack_require__.e("common"), __webpack_require__.e("settings-settings-module")]).then(__webpack_require__.bind(null, /*! ./settings/settings.module */ "./src/app/pages/navigation/settings/settings.module.ts")).then((m) => m.SettingsPageModule),
            },
            {
                path: '',
                redirectTo: 'request',
