$(function(e) {
	...
	var myChart = new Chart(ctx, {
		...
		data: {
			...
			datasets: [{
				...
				borderWidth: "5",
				backgroundColor: "rgb(231, 42, 26, 0.6)",
				data: [20, 20, 47, 20, 49, 20, 50]
			}, {
				label: "Register Users",
				borderColor: "rgb(5, 160, 31)",
				borderWidth: "5",
				backgroundColor: "rgba(5, 160, 31, 0.6)",
	...
	gradientStroke1.addColorStop(0, 'rgb(231, 42, 26, 0.0)');
	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 190);
	gradientStroke2.addColorStop(0, 'rgb(22, 41, 70, 0.0)');
	...
	gradientStroke1.addColorStop(0, 'rgb(231, 42, 26 ,0.8)');
	var gradientStroke2 = myCanvasContext.createLinearGradient(0, 0, 0, 300);
	gradientStroke2.addColorStop(0, 'rgb(5, 160, 31,0.8)');
	var myChart = new Chart(myCanvas, {
		type: 'bar',
		data: {
	...
	new Morris.Donut({
		...
		colors: ['#e72a1a', '#05a01f ', '#8d0bb7 ', '#0b7eb7'],
